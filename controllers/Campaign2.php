...
class Campaign2 extends CI_Controller {
	...
	public function _campaign2_output($output = null)
	{
		$this->load->view('campaign2',(array)$output);
	}
	...
	public function index()
	{
		try{
			...
			$crud->set_subject('Automatic Campaign');
			...
			$crud->required_fields('layer','name_campaign','total_recipient','start_date_campaign','start_time_campaign','layer1_text');
			$crud->add_fields('type','created_by','approved_by','layer','name_campaign','total_recipient','start_date_campaign','start_time_campaign','sti','sti_text','tone','tone_title','tone_duration','layer1_text','layer2_text','layer3_text','id_action','action_destination','sms_text','conflict');
			$crud->edit_fields('type','created_by','layer','name_campaign','total_recipient','start_date_campaign','start_time_campaign','sti','sti_text','tone','tone_title','tone_duration','layer1_text','layer2_text','layer3_text','id_action','action_destination','sms_text','conflict');
