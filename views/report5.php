...
<body>
    <div class="container-fluid gc-container">
		<table width="100%">
		<tr><td colspan=9><center><div class="table-label">&nbsp;Push Capacity</div></center></td></tr>
...
function done()
{
	...
	if($('#range').val()=="1")
	{
		$("#url").attr('download','Push Capacity (Today)'+new Date()+'.png');
	}
	if($('#range').val()=="2")
	{
		$("#url").attr('download','Push Capacity (Last 7 Days)'+new Date()+'.png');
	}
	if($('#range').val()=="3")
	{
		$("#url").attr('download','Push Capacity (Last 30 Days)'+new Date()+'.png');
	}
	if($('#range').val()=="4")
	{
		$("#url").attr('download','Push Capacity (This Month)'+new Date()+'.png');
	}
	if($('#range').val()=="5")
	{
		$("#url").attr('download','Push Capacity '+$('#start_date').val()+' to '+$('#end_date').val()+' '+new Date()+'.png');
	}
...
$('#range').val('2').trigger('chosen:updated');
					...
					$.ajax({
						url : "<?php echo base_url(); ?>Excel/createReport5?type=2",
						type : "GET",
						dataType: "text",
					...
					$("#download").attr('href',"<?php echo base_url(); ?>assets/uploads/files/Push Capacity (Last 7 Days).xlsx");			


					$.ajax({
						url : "<?php echo base_url(); ?>Report5/getReport?type=2",
						type : "GET",
						dataType: "text",
						success : function(data)
						{
							...
							var chartOptions = {
							  ...
							  title: {
								display: true,
								text: "Push Capacity (Last 7 Days)"
							  },
							  scales: {
								yAxes: [{
									position: 'left',
...
//		end_date = $("#end_date").val();
		var title = "Push Capacity from "+start_date+" to "+end_date;


					$.ajax({
						url : "<?php echo base_url(); ?>Excel/createReport5?type=5&start_date="+e.format(0,"yyyy-mm-dd")+"&end_date="+end_date,
						type : "GET",
						dataType: "text",
						success : function(data)
						{
					...
					$.ajax({
						url : "<?php echo base_url(); ?>Report5/getReport?type=5&start_date="+e.format(0,"yyyy-mm-dd")+"&end_date="+end_date,
						type : "GET",
						dataType: "text",
						success : function(data)
						{
...
//		start_date = $("#start_date").val();
		...
		var title = "Push Capacity from "+start_date+" to "+end_date;
					...
					$.ajax({
						url : "<?php echo base_url(); ?>Excel/createReport5?type=5&end_date="+e.format(0,"yyyy-mm-dd")+"&start_date="+start_date,
						type : "GET",
						dataType: "text",
						success : function(data)
						{
					...
					$.ajax({
						url : "<?php echo base_url(); ?>Report5/getReport?type=5&end_date="+e.format(0,"yyyy-mm-dd")+"&start_date="+start_date,
						type : "GET",
						dataType: "text",
						success : function(data)
						{
...
$('select').on('change', function(event, params) 
{
	...
	if(range=="5")
	{
		...
		var title = "Push Capacity from "+start_date+" to "+end_date;
					...
					$.ajax({
						url : "<?php echo base_url(); ?>Excel/createReport5?type="+range+"&start_date="+start_date+"&end_date="+end_date,
						type : "GET",
						dataType: "text",
						success : function(data)
						{
					...
					$.ajax({
						url : "<?php echo base_url(); ?>Report5/getReport?type="+range+"&start_date="+start_date+"&end_date="+end_date,
						type : "GET",
						dataType: "text",
						success : function(data)
						{
	...
	{	
		if(range==1)
		{	
		 var title = "Push Capacity (Today)";
		} 
		else if(range==2)
		{	
		 var title = "Push Capacity (Last 7 Days)";
		} 
		else if(range==3)
		{	
		 var title = "Push Capacity (Last 30 Days)";
		} 
		else if(range==4)
		{	
		 var title = "Push Capacity (This Month)";
		} 
		$("div.input-group.date").hide();

					$.ajax({
						url : "<?php echo base_url(); ?>Excel/createReport5?type="+range,
						type : "GET",
						dataType: "text",
						success : function(data)
						{
					...
					$.ajax({
						url : "<?php echo base_url(); ?>Report5/getReport?type="+range,
						type : "GET",
						dataType: "text",
						success : function(data)
						{
