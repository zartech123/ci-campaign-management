	...
	<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
	  ...
	  <div class="modal-content">
	      ...
	      <div class="modal-body">
	          <form class="form col-md-12 center-block" action="<?=base_url();?>Login/changepassword2" method="post">
	            ...
	            <div class="form-group">
	              ...
	              <a href="<?php echo base_url(); ?>Login">Back to Login</a><span id="error" class="pull-right" style='color:#a94442;'><?php if(isset($error)) echo "<span style='color:#a94442;'>$error</span>"; ?></span>
	            </div>
	          </form>
	      </div>
